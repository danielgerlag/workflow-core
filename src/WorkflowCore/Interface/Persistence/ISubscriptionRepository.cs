...
namespace WorkflowCore.Interface
{
    ...
    {        
        ...
        Task<EventSubscription> GetNextWorkflowSubscription(string eventName, string workflowId, string activityToExclude, DateTime asOf, CancellationToken cancellationToken = default);
