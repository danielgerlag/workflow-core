...
namespace WorkflowCore.Interface
{
    ...
    {
        Task<string> StartWorkflow(string workflowId, object data = null, string reference=null, string correlationId = null);
        Task<string> StartWorkflow(string workflowId, int? version, object data = null, string reference=null, string correlationId = null);
        Task<string> StartWorkflow<TData>(string workflowId, TData data = null, string reference=null, string correlationId = null) where TData : class, new();
        Task<string> StartWorkflow<TData>(string workflowId, int? version, TData data = null, string reference=null, string correlationId = null) where TData : class, new();
